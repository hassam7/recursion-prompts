export class TestRunner {
  ...
  async run({ code, specCode, libCache, mochaCss, timeoutMs = 10000 }) {
    const srcdoc = this.buildSrcdoc({ code, specCode, libCache, mochaCss });
    ...
    return new Promise((resolve, reject) => {
      ...
      this.testFrame.srcdoc = srcdoc;
    });
  }

  buildSrcdoc({ code, specCode, libCache, mochaCss }) {
